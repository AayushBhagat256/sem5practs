...
PARTITION BY KEY ()
partitions 3;
INSERT INTO Customer4 (Customer4ID, CustomerName, LastName, Country, Age, Phone)
...
select partition_name,table_rows from INFORMATION_SCHEMA.partitions where table_name="Customer4";
select * from customer4 partition(p1);
